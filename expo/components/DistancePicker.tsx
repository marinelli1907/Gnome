...
const styles = StyleSheet.create({
  ...
  chipActive: { backgroundColor: Colors.tradeBlueInteractive, borderColor: Colors.tradeBlueInteractive },
  ...
  tickActive: { backgroundColor: Colors.tradeBlueInteractive + '55' },
  thumb: {
    position: 'absolute',
    top: -11,
    width: 28,
